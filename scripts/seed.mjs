// Seed script — populates Sanity with initial content
// Usage: SANITY_TOKEN=<your-write-token> node scripts/seed.mjs
//
// Get a write token at: https://www.sanity.io/manage/personal/project/xdp1hvl6/api#tokens
...
if (!token) {
  ...
  console.error('   Run: SANITY_TOKEN=your_token node scripts/seed.mjs')
  process.exit(1)
}
...
const documents = [
  {
    ...
    slug: { _type: 'slug', current: 'loghi-brand-identity' },
    number: 1,
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'grafica-pubblicitaria' },
    number: 2,
  ...
  },
  {
    ...
    _type: 'service',
    title: 'Illustrazioni',
    slug: { _type: 'slug', current: 'illustrazioni' },
    number: 3,
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'character-design' },
    number: 4,
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'inviti-locandine' },
    number: 5,
  ...
  },
  {
    ...
    phone: '+393427404602',
    whatsapp: '393427404602',
    instagram: 'https://instagram.com/red_.artist_',
    tagline: 'Grafica originale. Sempre.',
  },
]
...
try {
  ...
  console.log('✅  Done! Documents created/updated:')
